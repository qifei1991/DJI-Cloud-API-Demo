...
import com.dji.sdk.cloudapi.interconnection.SpeakerPlayModeSetRequest;
import com.dji.sdk.cloudapi.interconnection.SpeakerPlayVolumeSetRequest;
...
public class SpeakerPlayService implements ISpeakerPlayService {
    ...
    @Autowired
    private SDKInternectionPublishService publishService;
    @Autowired
    ...
    public HttpResultResponse setPlayMode(String workspaceId, SpeakerPlaySetParam setParam) {
        ...
        // 设备定义topic
        this.speakerJobService.subscribe(setParam.getDeviceSn());

        TopicServicesResponse<ServicesReplyData> serviceReply = publishService.speakerPlayModeSet(
    ...
    public HttpResultResponse setPlayVolume(String workspaceId, SpeakerPlaySetParam setParam) {
        ...
        TopicServicesResponse<ServicesReplyData> serviceReply = publishService.speakerPlayVolumeSet(
                setParam.getDeviceSn(),
